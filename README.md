...
ZeroReferences 是一款基於 **Roslyn** (Microsoft.CodeAnalysis) 的 .NET 工具，能夠掃描整個解決方案 (.sln/.slnx)，找出所有 `public`/`private`/`protected` 方法中，**在整個解決方案內部完全沒有被引用**的「孤兒方法」。
